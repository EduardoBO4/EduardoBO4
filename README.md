...
%%{init: {
  ...
  "themeVariables": {
    ...
    "lineColor": "#C9184A",
    "secondaryColor": "#3B0A0F",
    "tertiaryColor": "#4A0E17",
    "background": "#1a1a1a",
    "mainBkg": "#58111A",
    "nodeTextColor": "#F5E6D3",
...
graph TD
    ...
    PUC_MINAS --> EDUARDO_CS
    EDUARDO_CS --> CORE_DEV
    EDUARDO_CS --> AI_EXPLORATION
    EDUARDO_CS --> AGILE_MANAGEMENT

    style EDUARDO_CS fill:#C9184A,stroke:#F5E6D3,stroke-width:2px,color:#FFFDD0
    style PUC_MINAS fill:#3B0A0F,stroke:#E63946,stroke-width:1px,color:#F5E6D3
    style CORE_DEV fill:#4A0E17,stroke:#E63946,stroke-width:1px,color:#F5E6D3
    style AI_EXPLORATION fill:#4A0E17,stroke:#E63946,stroke-width:1px,color:#F5E6D3
    style AGILE_MANAGEMENT fill:#4A0E17,stroke:#E63946,stroke-width:1px,color:#F5E6D3
```
...
<div align="center">
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:3B0A0F,100:4A0E17&height=6&section=footer" alt="divisor" width="100%"/>
</div>
